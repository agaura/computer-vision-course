                ...
                if i == 1 && j == 1
                    ...
                    while k < n
                        ...
                        if path(1,1,k) == path(1,1,k-1)
                            ...
                            %disp([hor(1) hor(2) vert(1) vert(2)]);
                            if k == 2
                                total = total + cum_cols(1, hor(2));
                            else
                                total = total + cum_cols(vert(1),hor(2)) - cum_cols(vert(1),vert(2));
                            end
                            k = l;
                        else
                            l = k;
                            ...
                            if k == 2
                                total = total + cum_rows(vert(1), 1);
                            else
                                total = total + cum_rows(vert(1),hor(2)) - cum_rows(hor(1),hor(2));
                            end
                            k = l;
                        end
                    end
